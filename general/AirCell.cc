...
void AirCell::printState() const {
    std::cout << velocitySquaredNorm() << " " << enthalpy << " " << temperature << " " << pressure
              << " " << vapourPressure << " " << saturationPressure << " " << isCloudy();
}

std::ostream& AirCell::printState(std::ostream& out) const {
    out << velocitySquaredNorm() << " " << enthalpy << " " << temperature << " " << pressure << " "
        << vapourPressure << " " << saturationPressure << " " << isCloudy();
    return out;
}
