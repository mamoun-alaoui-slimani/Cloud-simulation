 ...
 * @param Vk_p1
 */
void Potential::computeLaplacian(Potential const& Vi_m1, Potential const& Vj_m1,
                                 Potential const& Vk_m1, Potential const& Vi_p1,
                                 Potential const& Vj_p1, Potential const& Vk_p1) {
    laplacian = Vi_m1.potential + Vj_m1.potential + Vk_m1.potential - 6 * potential +
                Vi_p1.potential + Vj_p1.potential + Vk_p1.potential;
}
 ...
 */
void Potential::velocity(std::array<double, 3>& velocity, Potential const& Pi_m1,
                         Potential const& Pj_m1, Potential const& Pk_m1, Potential const& Pi_p1,
                         Potential const& Pj_p1, Potential const& Pk_p1) const {
    velocity[0] = Pj_p1.potential.getY() - Pj_m1.potential.getY() - Pk_p1.potential.getX() +
                  Pk_m1.potential.getX();
