...
public:
    ...
    Potential(Vector2D const& p, Vector2D const& l) : potential(p), laplacian(l) {}
    ...
    void velocity(std::array<double, 3>& velocity, Potential const& Pi_m1, Potential const& Pj_m1,
                  Potential const& Pk_m1, Potential const& Pi_p1, Potential const& Pj_p1,
                  Potential const& Pk_p) const;
